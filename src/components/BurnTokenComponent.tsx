  ...
  return (
    <div className="burn-container">
      ...
      <div className="instructions-section">
        ...
        <div className="instructions-card">
          ...
          <ol className="steps">
            ...
            <li>Click "Burn Tokens" and confirm the transaction</li>
          </ol>
        </div>
      </div>
      ...
      <div className="wallet-section">
        ...
        <p>Connect your wallet to burn WSOL tokens</p>
      ...
      {wallet.connected && (
        <div className="burn-form">
          <div className="amount-input">
            <label>Amount of WSOL to burn</label>
            ...
            <p className="conversion-rate">1 WSOL = 1 SOL</p>
          </div>
